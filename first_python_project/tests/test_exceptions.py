...
class TestExceptions:
    ...
    def test_element_not_interactable_exception(self, driver):
        ...
        assert confirmation_message == "Row 2 was saved", "Cofirmation message is not expected"
    ...
    def test_stale_element_reference_exception(self, driver):
        ...
        wait = WebDriverWait(driver, 10)
        assert wait.until(ec.invisibility_of_element_located((By.ID, "add_btn")), "Instruction text element should not be displayed")
